...
{
    class UnCursedOutcomePC : CustomCard
    {
        ...
        public override void SetupCard(CardInfo cardInfo, Gun gun, ApplyCardStats cardStats, CharacterStatModifiers statModifiers, Block block)
        {
            ...
            cardInfo.categories = new CardCategory[] { ChaosPoppycarsCardsCore.CPCCoreCardCategories.PoppysChaosCategory, CurseManager.instance.curseInteractionCategory };
            gun.damage = 1.15f;
