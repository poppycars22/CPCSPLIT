    ...
    class HealthBounces : CustomCard
    {
        public override void SetupCard(CardInfo cardInfo, Gun gun, ApplyCardStats cardStats, CharacterStatModifiers statModifiers, Block block)
        {
            ...
            gun.objectsToSpawn = new ObjectsToSpawn[]
            {
              new ObjectsToSpawn ()
              {
                  AddToProjectile = ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("HealthBounceObject")
              },
        ...
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_HealthBounces");
        }
