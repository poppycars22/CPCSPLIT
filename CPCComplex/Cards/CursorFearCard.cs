...
{
    class CursorFearCard : CustomCard
    {
        ...
        {
            return "You hate the cursor and always move away from it";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_CursorFear");
        }
