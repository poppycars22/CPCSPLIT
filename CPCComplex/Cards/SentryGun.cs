...
namespace CPCComplex.Cards
{
    class SentryGun : CustomCard
    {
        ...
        {
            return "When you block you spawn or move your sentry that fires when you fire, be careful of the limited ammo (idea stolen from root)";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_SentryGun");
        }
