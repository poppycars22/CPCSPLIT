...
namespace CPCComplex.Cards
{
    class RightLegOfTheForbiddenOne : CustomCard
    {
        ...
        {
            if (player.data.currentCards.Contains(ExodiaTheForbiddenOne.Card) && player.data.currentCards.Contains(LeftArmOfTheForbiddenOne.Card) && player.data.currentCards.Contains(RightArmOfTheForbiddenOne.Card) && player.data.currentCards.Contains(LeftLegOfTheForbiddenOne.Card))
            {
        ...
        {
            return "Right Leg of the Forbidden One";
        }
        protected override string GetDescription()
        {
            return "A forbidden right leg sealed by magic. Whosoever breaks this seal will know infinite power.";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_RightLegOfTheForbiddenOne");
        }
