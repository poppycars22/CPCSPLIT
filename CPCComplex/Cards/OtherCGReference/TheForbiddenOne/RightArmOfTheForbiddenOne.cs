...
{
    class RightArmOfTheForbiddenOne : CustomCard
    {
        ...
        {
            if (player.data.currentCards.Contains(ExodiaTheForbiddenOne.Card) && player.data.currentCards.Contains(LeftArmOfTheForbiddenOne.Card) && player.data.currentCards.Contains(LeftLegOfTheForbiddenOne.Card) && player.data.currentCards.Contains(RightLegOfTheForbiddenOne.Card))
            {
        ...
        {
            return "Right Arm of the Forbidden One";
        }
        protected override string GetDescription()
        {
            return "A forbidden right arm sealed by magic. Whosoever breaks this seal will know infinite power.";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_RightArmOfTheForbiddenOne");
        }
