...
{
    class LeftLegOfTheForbiddenOne : CustomCard
    {
        ...
        {
            if (player.data.currentCards.Contains(ExodiaTheForbiddenOne.Card) && player.data.currentCards.Contains(LeftArmOfTheForbiddenOne.Card) && player.data.currentCards.Contains(RightArmOfTheForbiddenOne.Card) && player.data.currentCards.Contains(RightLegOfTheForbiddenOne.Card))
            {
        ...
        {
            return "Left Leg of the Forbidden One";
        }
        protected override string GetDescription()
        {
            return "A forbidden left leg sealed by magic. Whosoever breaks this seal will know infinite power.";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_LeftLegOfTheForbiddenOne");
        }
