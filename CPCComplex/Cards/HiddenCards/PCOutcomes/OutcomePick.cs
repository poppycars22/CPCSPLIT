...
namespace CPCComplex.Cards
{
    class OutcomePick : CustomCard
    {
        ...
        {
            PickManager.QueueLimitedDraw(player, ModdingUtils.Utils.Cards.instance.HiddenCards.Where(card => card.categories.Contains(ChaosPoppycarsCardsCore.CPCCoreCardCategories.PoppysChaosCategory)).ToList());
