...
namespace CPCComplex.Cards
{
    class RaveCard : CustomCard
    {
        ...
        {
            var a = player.gameObject.GetOrAddComponent<RPCMono>();
        ...
        {
            return "And so the rave continues on";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsComplex.Bundle.LoadAsset<GameObject>("C_Rave");
        }
