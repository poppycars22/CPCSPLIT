...
namespace CPCCrafter.Cards
{
    class IronGolem : CustomCard
    {
        ...
        {
            characterStats.GetAdditionalData().upwardsKnockback += 2f;
        ...
        {
            return "Launch your foes into the air";
        }
        protected override GameObject GetCardArt()
        {
            return ChaosPoppycarsCardsCrafter.Bundle.LoadAsset<GameObject>("C_IronGolem");
        }
