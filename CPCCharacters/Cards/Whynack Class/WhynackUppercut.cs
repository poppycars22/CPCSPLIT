...
{
    class WhynackUppercut : CustomCard
    {
        internal static CardInfo Card = null;
        public override void SetupCard(CardInfo cardInfo, Gun gun, ApplyCardStats cardStats, CharacterStatModifiers statModifiers, Block block)
        {
            block.healing = 40;
            block.forceToAddUp = 15;
        ...
        public override void OnAddCard(Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
        {
            if (block.cooldown - 0.275f > 0.15f)
                block.cdAdd -= 0.275f;
            characterStats.GetAdditionalData().whynackUpper = true;
        ...
        {
            return "Whynack Uppercut";
        }
        protected override string GetDescription()
        {
            return "My skull will break your bones [launch yourself upwards against opponents to harm them]";
        }
