...
namespace CPCTabInfoSTATS
{
    public class TabinfoInterface
    {
        public static void Setup()
        {
            ...
            TabInfoManager.RegisterStat(OtherStats, "Extra Damage", (p) => p.data.stats.GetAdditionalData().DamageAmpDamage != 0, (p) => string.Format("{0:F0}", p.data.stats.GetAdditionalData().DamageAmpDamage));
