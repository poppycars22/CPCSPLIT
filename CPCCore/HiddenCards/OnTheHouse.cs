...
namespace CPCCore.Cards
{
    class OnTheHouse : CustomCard
    {
        ...
        {
            var gameModeHandler = GameModeManager.CurrentHandler;
            var score = gameModeHandler.GetTeamScore(player.teamID);
            var newScore = new TeamScore(score.points, score.rounds+1);
